...
const TcpBackwardResponse = module.exports = defunction(['Uint8Array', 'Uint8Array'], '*', function Response(socketId, data) {
  ...
  _.merge(this, { type: 'tcpBackward', socketId, data })
})

TcpBackwardResponse.prototype.getPojo = defunction([], 'Object', function getPojo() {
  return {
    branch: this.type,
    value: {
...
TcpBackwardResponse.prototype.getEncoding = defunction([], 'Uint8Array', function getEncoding() {
