...
const TcpProxyCommand = module.exports = defunction(['Uint8Array', 'Uint8Array', 'string', 'Uint8Array'], '*', function Command(aesKey, port, addressType, address) {
  _.merge(this, { aesKey, port, addressType, address })
})
